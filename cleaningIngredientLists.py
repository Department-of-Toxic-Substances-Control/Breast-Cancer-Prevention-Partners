...
ingredientLists["ingredientList"] = (ingredientLists.ingredientList.str.replace(naturallyDerivedStart, "")
                                     ...
                                     .str.replace(r"(?<= [0-9]), (?=[1-9]{1,2}-[ a-zA-Z])", ",")
                                     .str.replace(r"(?<=[0-9],[1-9]) ?- ?(?=[a-zA-Z])", "-")
                                     .str.replace("2-OLEAMIDO-1, 3-OCTADECANEDIOL", "2-OLEAMIDO-1,3-OCTADECANEDIOL", regex=False)
